...
let comparison_With_Strings = text1 && text1 || text1 && hello;
...
let itemToCheck1: string = "Banana";
...
let fruitsCopy: string[] = ["Apple", "Banana", "Orange"];
//test kiwi is not in the fruits array
let itemToCheck2: string = "Kiwi";
